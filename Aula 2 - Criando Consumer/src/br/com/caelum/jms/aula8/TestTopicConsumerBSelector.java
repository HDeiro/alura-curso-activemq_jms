...
public class TestTopicConsumerBSelector {
	public static void main(String[] args) throws Exception {
		...
		connection.setClientID("topic-consumer-b"); /** !Important to check wich consumer is this*/
		connection.start();
		...
		MessageConsumer consumer = session.createDurableSubscriber(topic, "assinatura-selector-b", "property1=true OR property2 < 4000", false);
		...
		consumer.setMessageListener(new MessageListener() {
			...
			public void onMessage(Message message) {
				...
				try {
					Serializable order = objectMessage.getObject();
